  ...
  render() {
    ...
    return (
      <header className="header">
          ...
          <ul className="social-links">
            ...
            <li><a href="https://www.youtube.com/user/hotosm">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="0 0 20 14">
                <path fill="#D73F3F" fillRule="evenodd"
                      d="M7.84,9.874928 L12.992,6.944112 L7.84,4.013072 L7.84,9.874928 Z M19.300064,2.168656 C19.712,3.715824 19.712,6.944 19.712,6.944 C19.712,6.944 19.712,10.172064 19.300064,11.719456 C19.073376,12.573008 18.40552,13.245232 17.557344,13.473488 C16.020144,13.888 9.856,13.888 9.856,13.888 C9.856,13.888 3.691856,13.888 2.154656,13.473488 C1.306592,13.245232 0.638624,12.573008 0.411936,11.719456 C0,10.172064 0,6.944 0,6.944 C0,6.944 0,3.715824 0.411936,2.168656 C0.638624,1.314992 1.306592,0.642768 2.154656,0.414624 C3.691856,0 9.856,0 9.856,0 C9.856,0 16.020144,0 17.557344,0.414624 C18.40552,0.642768 19.073376,1.314992 19.300064,2.168656 Z"
                      transform="translate(.144)"/>
              </svg>
        ...
        <div className="menu-project-selector">
          {/* 'Project' button */}
